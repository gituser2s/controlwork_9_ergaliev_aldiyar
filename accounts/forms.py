...
class CustomUserCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('username', 'email',  'avatar', 'password', 'password_confirm', 'gender')
...
class UserChangeForm(forms.ModelForm):
    class Meta:
        model = get_user_model()
        fields = ('username', 'avatar', 'email', 'gender')
        labels = {'username': 'Логин', 'email': 'Почта', 'avatar': 'Аватар', 'gender': 'Пол'}
